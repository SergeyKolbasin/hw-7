...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 06 2022 г., 15:57
...
(1, 8, 12, 1, '2022-02-04 15:02:30'),
(3, 8, 9, 1, '2022-02-04 15:02:51'),
(4, 7, 1, 1, '2022-02-04 15:20:36'),
(6, 3, 2, 1, '2022-02-04 15:21:58'),
(7, 3, 10, 1, '2022-02-04 15:22:06'),
(8, 3, 14, 1, '2022-02-04 15:22:15'),
(10, 8, 4, 1, '2022-02-06 08:09:10'),
(11, 8, 10, 1, '2022-02-06 14:48:02');
...
(1, 0, 'img/product/1.jpg', 170934, 'Дельфин', 'Дельфины (др.-греч. δελφῖνος, δελφίς) — водные млекопитающие инфраотряда китообразных, принадлежащие либо к семейству дельфиновых (Delphinidae) — морские, либо к надсемейству речных дельфинов (Platanistoidea) — пресноводные.', 47, '127.00'),
...
(3, 0, 'img/product/3.jpg', 372746, 'Коала', 'Коала (лат. Phascolarctos cinereus) — вид сумчатых, обитающий в Австралии. Единственный современный представитель семейства коаловых (Phascolarctidae) из отряда двурезцовых сумчатых (Diprotodontia).', 27, '56.09'),
...
(6, 0, 'img/product/6.jpg', 365881, 'Панда', 'Панда (лат. Ailuridae) — семейство млекопитающих из подотряда псообразные (Caniformia) отряда хищных. Включает семь вымерших и один современный род. Единственный современный вид — малая, или красная панда (Ailurus fulgens).', 37, '90.43'),
(7, 0, 'img/product/7.jpg', 254168, 'Белый медведь', '\'Белый медведь, или полярный медведь, северный медведь, ошкуй, нанук, умка (лат. Ursus maritimus — «медведь морской») — хищное млекопитающее семейства медвежьих, близкий родственник бурого медведя. Второй по величине сухопутный хищник планеты после гребнистого крокодила. Назван так из-за белой шерсти.', 33, '89.33'),
...
--
ALTER TABLE `baskets`
  MODIFY `id` smallint(5) NOT NULL AUTO_INCREMENT COMMENT 'id записи корзины', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `gallery`
--
ALTER TABLE `gallery`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id товара', AUTO_INCREMENT=17;
